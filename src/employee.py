...
def get_employees():
    ...
    return [{
        ...
        'join_date': emp[5],
        'work_mobile': emp[6],
        'personal_mobile': emp[7],
        'personal_email': emp[8],
        'work_email': emp[9],
        'work_phone': emp[10],
        'coach_id': emp[11],
        'parent_id': emp[12],
        'department_id': emp[13],
        'job_id': emp[14],
        'resource_calendar_id': emp[15],
        'country_id': emp[16],
        'identification_id': emp[17],
        'passport_id': emp[18],
        'passport_expiry_date': emp[19],
        'tin_no': emp[20],
        'hr_bank_account': emp[21],
        'blood_group_type': emp[22],
        'father_name': emp[23],
        'grand_father_name': emp[24],
        'mother_name': emp[25],
        'current_address': emp[26],
        'permanent_address': emp[27],
        'birthday': emp[28],
        'place_of_birth': emp[29],
        'gender': emp[30],
        'marital': emp[31],
        'children': emp[32],
        'completed_police_clearance': emp[33],
        'completed_pikaz_clearance': emp[34],
        'company_id': emp[35]
